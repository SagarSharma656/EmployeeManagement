...
export default function UpdateEmployeeModal({ isOpen, onClose, onSubmit, formData, setFormData }) {
                ...
                <form onSubmit={onSubmit} className="space-y-2 text-sm">
                    <div className="flex justify-center items-center">
                        <label htmlFor="profile" className="text-sm mb-1 cursor-pointer">
                        {
                            ...
                            :
                            <img src={formData?.imageUrl} alt="" className="w-18 h-18 rounded-full" />
                        }
                        </label>
